...
To wrap up our discussion on the Fourier Transform, and to conclude our larger discussion on PDEs as a whole, we will show that the solutions to the heat equation derived using the heat kernel, and the solutions derived using Fourier Transform, are equivalent. In particular, recall that the problem
...
Before we can show they are equivalent, we first need to understand how Fourier Transform interacts with certain operation. 
