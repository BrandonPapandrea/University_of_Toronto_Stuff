...
Another way is to look back at Frege's assumption and modify it: instead of saying all concepts have extensions, we say that only ``safe'' ones do. What is ``safe?'' That takes some work, and many of done work in this area. Some, however, have argued that the idea that certain concepts have no extensions, called the \textbf{limitation of size} is unnatural. In general, the problem of distinguishing between concepts that have extensions, and those that do not, is called the \textbf{Bad Company Problem}.
